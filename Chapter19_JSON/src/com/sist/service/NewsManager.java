...
public class NewsManager {
	public static void main(String[] args) {
		List<NewsVO> list=find("야구");
		for(NewsVO vo:list) {
			System.out.println(vo.getTitle());
		}
	}
    public static List<NewsVO> find(String fd) {
        ...
        String apiURL = "https://openapi.naver.com/v1/search/news.json?display=50&query=" + text;    // JSON 결과 // MAX = 100개
